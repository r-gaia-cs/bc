...
Now let's use the \code{sort} command to sort its contents. This does
...
If we run \code{wc -l *.pdb \textbar{} sort} instead, the shell
...
\code{wc -l *.pdb \textbar{} sort \textbar{} head -1}, we get three
