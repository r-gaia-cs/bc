...
<pre class="in">!cat sys-version.py</pre>

<div class="out"><pre class='out'>import sys
...
<pre class="in">%run sys-version.py</pre>

<div class="out"><pre class='out'>version is 2.7.5 |Anaconda 1.8.0 (x86_64)| (default, Oct 24 2013, 07:02:20) 
...
<pre class="in">!ipython sys-version.py</pre>
...
<pre class="in">!cat argv-list.py</pre>
...
<pre class="in">!ipython argv-list.py</pre>

<div class="out"><pre class='out'>sys.argv is [&#39;/Users/gwilson/s/bc/python/novice/argv-list.py&#39;]
</pre></div>
...
<pre class="in">!ipython argv-list.py first second third</pre>

<div class="out"><pre class='out'>sys.argv is [&#39;/Users/gwilson/s/bc/python/novice/argv-list.py&#39;, &#39;first&#39;, &#39;second&#39;, &#39;third&#39;]
</pre></div>
...
<pre class="in">!cat readings-01.py</pre>
...
<pre class="in">%run readings-01.py inflammation-01.csv</pre>
...
<pre class="in">!cat readings-02.py</pre>
...
<pre class="in">%run readings-02.py inflammation-01.csv</pre>

<div class="out"><pre class='out'>5.45
5.425
6.1
5.9
5.55
...
<pre class="in">!ls small-*.csv</pre>

<div class="out"><pre class='out'>small-01.csv small-02.csv small-03.csv
</pre></div>


<pre class="in">!cat small-01.csv</pre>

<div class="out"><pre class='out'>0,0,1
0,1,2
</pre></div>


<pre class="in">%run readings-02.py small-01.csv</pre>

<div class="out"><pre class='out'>0.333333333333
1.0
</pre></div>
...
<pre class="in">!cat readings-03.py</pre>
...
<pre class="in">%run readings-03.py small-01.csv small-02.csv</pre>
...
<pre class="in">!cat readings-04.py</pre>
...
<pre class="in">%run readings-04.py --max small-01.csv</pre>

<div class="out"><pre class='out'>1.0
2.0
</pre></div>
...
<pre class="in">!cat readings-05.py</pre>
...
<pre class="in">!cat count-stdin.py</pre>
...
<pre class="in">!ipython count-stdin.py &lt; small-01.csv</pre>

<div class="out"><pre class='out'>2 lines in standard input
</pre></div>
...
<pre class="in">%run count-stdin.py &lt; small-01.csv</pre>

<div class="out"><pre class='out'>0 lines in standard input
</pre></div>
...
<pre class="in">!ipython readings-06.py --mean &lt; small-01.csv | head -10</pre>

<div class="out"><pre class='out'>[TerminalIPythonApp] CRITICAL | Bad config encountered during initialization:
...
<pre class="in">!ipython readings-06.py -- --mean &lt; small-01.csv</pre>
