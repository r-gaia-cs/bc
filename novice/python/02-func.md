...
<pre class="in">def fahr_to_kelvin(temp):
...
<pre class="in">print &#39;freezing point of water:&#39;, fahr_to_kelvin(32)
print &#39;boiling point of water:&#39;, fahr_to_kelvin(212)</pre>

<div class="out"><pre class='out'>freezing point of water: 273.15
...
<pre class="in"># We&#39;ll use temp = 212, the boiling point of water, which was incorrect
print &#34;212 - 32:&#34;, 212 - 32</pre>

<div class="out"><pre class='out'>212 - 32: 180
</pre></div>


<pre class="in">print &#34;(212 - 32) * (5/9):&#34;, (212 - 32) * (5/9)</pre>

<div class="out"><pre class='out'>(212 - 32) * (5/9): 0
</pre></div>
...
<pre class="in">print &#39;10/3 is:&#39;, 10/3</pre>

<div class="out"><pre class='out'>10/3 is: 3
</pre></div>
...
<pre class="in">print &#39;10.0/3 is:&#39;, 10.0/3</pre>

<div class="out"><pre class='out'>10.0/3 is: 3.33333333333
</pre></div>
...
<pre class="in">def kelvin_to_celsius(temp):
    return temp - 273.15

print &#39;absolute zero in Celsius:&#39;, kelvin_to_celsius(0.0)</pre>

<div class="out"><pre class='out'>absolute zero in Celsius: -273.15
</pre></div>
...
<pre class="in">def fahr_to_celsius(temp):
...
<div class="out"><pre class='out'>freezing point of water in Celsius: 0.0
</pre></div>
...
<pre class="in">print &#39;final value of temp after all function calls:&#39;, temp</pre>
...
NameError: name &#39;temp&#39; is not defined</pre><pre class='out'>final value of temp after all function calls:</pre></div>
...
<div class="out"><pre class='out'> span of data 20.0
</pre></div>
...
<pre class="in">diff = numpy.loadtxt(fname=&#39;inflammation-01.csv&#39;, delimiter=&#39;,&#39;)
...
<pre class="in">z = numpy.zeros((2,2))
print center(z, 3)</pre>

<div class="out"><pre class='out'>[[ 3.  3.]
 [ 3.  3.]]
</pre></div>
...
<pre class="in">data = numpy.loadtxt(fname=&#39;inflammation-01.csv&#39;, delimiter=&#39;,&#39;)
print center(data, 0)</pre>

<div class="out"><pre class='out'>[[-6.14875 -6.14875 -5.14875 ..., -3.14875 -6.14875 -6.14875]
...
<pre class="in">print &#39;original min, mean, and max are:&#39;, data.min(), data.mean(), data.max()
centered = center(data, 0)
print &#39;min, mean, and and max of centered data are:&#39;, centered.min(), centered.mean(), centered.max()</pre>

<div class="out"><pre class='out'>original min, mean, and max are: 0.0 6.14875 20.0
...
<pre class="in">print &#39;std dev before and after:&#39;, data.std(), centered.std()</pre>

<div class="out"><pre class='out'>std dev before and after: 4.61383319712 4.61383319712
</pre></div>
...
<pre class="in">print &#39;difference in standard deviations before and after:&#39;, data.std() - centered.std()</pre>

<div class="out"><pre class='out'>difference in standard deviations before and after: -3.5527136788e-15
</pre></div>
...
<pre class="in"># center(data, desired): return a new array containing the original data centered around the desired value.
...
<pre class="in">numpy.loadtxt(&#39;inflammation-01.csv&#39;, delimiter=&#39;,&#39;)</pre>
...
<pre class="in">numpy.loadtxt(&#39;inflammation-01.csv&#39;, &#39;,&#39;)</pre>
...
TypeError: data type &#34;,&#34; not understood</pre></div>
...
<pre class="in">def center(data, desired=0.0):
...
<pre class="in">test_data = numpy.zeros((2, 2))
...
<pre class="in">more_data = 5 + numpy.zeros((2, 2))
print &#39;data before centering:&#39;, more_data
print &#39;centered data:&#39;, center(more_data)</pre>

<div class="out"><pre class='out'>data before centering: [[ 5.  5.]
 [ 5.  5.]]
centered data: [[ 0.  0.]
 [ 0.  0.]]
</pre></div>
...
<pre class="in">def display(a=1, b=2, c=3):
    print &#39;a:&#39;, a, &#39;b:&#39;, b, &#39;c:&#39;, c
...
<div class="out"><pre class='out'>no parameters:
a: 1 b: 2 c: 3
one parameter:
a: 55 b: 2 c: 3
two parameters:
...
<pre class="in">print &#39;only setting the value of c&#39;
display(c=77)</pre>

<div class="out"><pre class='out'>only setting the value of c
a: 1 b: 2 c: 77
</pre></div>
...
<pre class="in">help(numpy.loadtxt)</pre>

<div class="out"><pre class='out'>Help on function loadtxt in module numpy.lib.npyio:
