...
<pre class="in">!ls *.txt</pre>

<div class="out"><pre class='out'>UK_Sunshine_data.txt  UK_Tmean_data.txt
</pre></div>
...
<pre class="in">!head UK_Tmean_data.txt</pre>

<div class="out"><pre class='out'>UK Mean Temperature (Degrees C)
...
<pre class="in">!python reformat_weather_data.py UK_Tmean_data.txt | head</pre>

<div class="out"><pre class='out'>month,value
1910-01-01,2.6
1910-02-01,2.6
1910-03-01,4.0
1910-04-01,6.4
...
<pre class="in">!pip install doit</pre>

<div class="out"><pre class='out'>Requirement already satisfied (use --upgrade to upgrade): doit in /usr/local/lib/python2.7/dist-packages
...
<pre class="in">!head UK_Tmean_data.reformatted.txt</pre>
