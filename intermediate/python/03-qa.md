...
<pre class="in">open(&#39;nonexistent-file.txt&#39;, &#39;r&#39;)</pre>
...
IOError: [Errno 2] No such file or directory: &#39;nonexistent-file.txt&#39;</pre></div>


<pre class="in">values = [0, 1, 2]
...
<div class="out"><pre class='out'>Whoops!
</pre></div>
...
<pre class="in">from rectangle import rectangle_area
...
<pre class="in">assert rectangle_area([0, 1, 4, 7]) == 24.0
assert rectangle_area([1, 1, 4, 4]) == 9.0
...
<pre class="in">def test_unit_square():
    assert rectangle_area([0, 0, 1, 1]) == 1.0
...
<pre class="in">import ears
ears.run()</pre>

<div class="out"><pre class='out'>..f
