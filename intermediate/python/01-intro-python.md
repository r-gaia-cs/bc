...
<pre class="in">import pandas</pre>
...
<pre class="in">pandas.read_csv(&#39;mosquito_data_A1.csv&#39;)</pre>
...
<pre class="in">data = pandas.read_csv(&#39;mosquito_data_A1.csv&#39;)</pre>
...
<div class="out"><pre class='out'>&lt;class &#39;pandas.core.frame.DataFrame&#39;&gt;
</pre></div>
...
<pre class="in">print data[&#39;year&#39;]</pre>

<div class="out"><pre class='out'>0    2001
1    2002
2    2003
3    2004
4    2005
...
<pre class="in">print data[[&#39;rainfall&#39;, &#39;temperature&#39;]]</pre>

<div class="out"><pre class='out'>   rainfall  temperature
0       222           87
1       103           72
2       176           77
3       236           89
...
<pre class="in">print data[0:2]</pre>
...
KeyError: u&#39;no item named 1&#39;</pre></div>
...
<pre class="in">print data[1:2]</pre>
...
<pre class="in">print data.iloc[1]</pre>

<div class="out"><pre class='out'>year           2002
temperature      72
rainfall        103
mosquitos       105
Name: 1, dtype: int64
...
<pre class="in">print data.iloc[1:3]</pre>
...
<pre class="in">print data[&#39;temperature&#39;][data[&#39;year&#39;] &gt; 2005]</pre>

<div class="out"><pre class='out'>5    89
6    71
7    88
8    85
9    75
...
<div class="out"><pre class='out'>year           2005.5
temperature      82.1
rainfall        187.1
mosquitos       171.4
dtype: float64
...
<pre class="in">print data.max()</pre>

<div class="out"><pre class='out'>year           2010
temperature      89
rainfall        283
mosquitos       242
dtype: int64
...
<pre class="in">print data[&#39;temperature&#39;].min()</pre>

<div class="out"><pre class='out'>71
</pre></div>


<pre class="in">print data[&#39;mosquitos&#39;][1:3].std()</pre>

<div class="out"><pre class='out'>43.1335136524
</pre></div>
...
<pre class="in">temps = data[&#39;temperature&#39;]
for temp_in_f in temps:
    temp_in_c = (temp_in_f - 32) * 5 / 9.0
    print temp_in_c</pre>

<div class="out"><pre class='out'>30.5555555556
22.2222222222
25.0
31.6666666667
31.1111111111
...
<pre class="in">print &#39;10/3.0 is:&#39;, 10 / 3.0</pre>

<div class="out"><pre class='out'>10/3.0 is: 3.33333333333
</pre></div>
...
<pre class="in">temp = data[&#39;temperature&#39;][0]
if temp &gt; 80:
    print &#34;The temperature is greater than 80&#34;</pre>

<div class="out"><pre class='out'>The temperature is greater than 80
</pre></div>
...
<div class="out"><pre class='out'> The temperature is equal to 87
</pre></div>
...
<pre class="in">from matplotlib import pyplot as plt</pre>
...
<pre class="in">data = pandas.read_csv(&#39;mosquito_data_A2.csv&#39;)
plt.plot(data[&#39;year&#39;], data[&#39;mosquitos&#39;])</pre>

<div class="out"><pre class='out'>[&lt;matplotlib.lines.Line2D at 0x4a88590&gt;]</pre>
...
<pre class="in">plt.figure(figsize=(10.0, 3.0))
